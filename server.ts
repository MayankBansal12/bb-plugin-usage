...
export const rpcContract = defineRpcContract({
  dashboard: { input: z.null(), output: z.object({
    ...
    records: z.array(usageRecordSchema), sources: z.array(sourceStateSchema), notice: z.string(),
  }) },
...
export default async function plugin(bb: BbPluginApi) {
  ...
  bb.storage.migrate(db, [migration, pricingMigration, multiAgentMigration]);
